...
export const useWithAuth = (): AxiosInstance => {
    const context = useContext(AuthContext);
    if (AuthContext === null || context === null || context.authTokens === null) return baseAxiosInstance;
    ...
    axiosInstance.interceptors.request.use(async (req) => {
        ...
        const response = await axios.post<ITokens>(apiEndpoints.refreshToken, {
